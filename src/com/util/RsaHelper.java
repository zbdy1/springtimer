...
public class RsaHelper {
	...
	/**
	 * 
	 * 方法名称：generateRSAKeyPair 
	 * 
	 * 方法功能：生成RSA密钥对(默认密钥长度为1024)
	 * 
	 * 参数说明：@return
	 * 
	 * 返回：KeyPair
	...
	/**
	 * 
	 * 方法名称：getPubKeyFromCRT 
	 * 
	 * 方法功能：从公钥证书中读取公钥
	 * 
	 * 参数说明：@param crtFileName
	 * 参数说明：@return
	 ...
	 * 方法功能：生成RSA密钥对
	 * 
	 * 参数说明：@param keyLength 密钥长度，范围：512～2048
	 * 参数说明：@return
	 * 
	 * 返回：KeyPair
	 * 
	...
	/**
	 * 
	 * 方法名称：encryptDataFromStr 
	 * 
	 * 方法功能：根据指定公钥进行明文加密
	 * 
	 * 参数说明：@param plainText 要加密的明文数据
	 * 参数说明：@param pubKey 公钥
	 * 参数说明：@return
	 * 
	 * 返回：String
	 * 
	 ...
	 * 方法名称：signData 
	 * 
	 * 方法功能：根据指定私钥对数据进行签名(默认签名算法为"SHA1withRSA")
	 * 
	 * 参数说明：@param data 要签名的数据
	 * 参数说明：@param priKey 私钥
	 * 参数说明：@return
	 * 
	 * 返回：byte[]
	 * 
	 ...
	 * 方法名称：signData 
	 * 
	 * 方法功能：根据指定私钥和算法对数据进行签名
	 * 
	 * 参数说明：@param data 要签名的数据
	 * 参数说明：@param priKey 私钥
	 * 参数说明：@param algorithm 签名算法
	 * 参数说明：@return
	 * 
	 * 返回：byte[]
	 * 
	 ...
	 * 方法名称：verifySign 
	 * 
	 * 方法功能：用指定的公钥进行签名验证(默认签名算法为"SHA1withRSA")
	 * 
	 * 参数说明：@param data 数据
	 * 参数说明：@param sign 签名结果
	 * 参数说明：@param pubKey 公钥
	 * 参数说明：@return
	 * 
	 * 返回：boolean
